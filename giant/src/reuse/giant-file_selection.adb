...
-- Modified by Steffen Pingel for GIANT
--  * Changed call: Set_Show_File_Op_Buttons (Dialog, True);
...
package body Giant.File_Selection is
   ...
   begin
      ...
      Set_Modal (Dialog);
      Set_Show_File_Op_Buttons (Dialog, True);
